...
var Player = {
	...
	'Install': function() {
		$$("GxInstall").innerHTML='<iframe src="/app/install/?u='+this.Download+'" scrolling="no" width="'+this.Width+'" height="'+this.Height+'" frameborder="0" marginheight="0" marginwidth="0"></iframe>';
	},
	'Navigate': function() {
		this.Send('navigate');
