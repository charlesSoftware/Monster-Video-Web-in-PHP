...
<div class="clear"></div>
<div id="content">
<form name="colform" action="?s=Admin/CustomCollectinfo/Add" method="post" id="colform">
...
<table width="100%"  class="table_form"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="20%">确定要预览吗？<span class="red" id="curren_url"></span></td>
     <td  align="left"><input type="submit" id="test" value="预览" class="bginput"  onclick="colform.action='?s=Admin/CustomCollectinfo/ColTest';"  ></td>
  </tr>
